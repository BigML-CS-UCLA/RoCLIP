...
def parse_args():
    ...
    parser.add_argument("--epochs", type = int, default = 24, help = "Number of train epochs")
    ...
    parser.add_argument("--RoCLIP_switch", action = "store_true", default = False, help = "activate switching RoCLIP and CLIP")
    parser.add_argument("--memory_bank_size", type = int, default = 21845, help = "memory bank size")
    parser.add_argument("--cross_aug", action = "store_true", default = False, help = "augmentation on input data")
    parser.add_argument("--break_epoch", type = int, default = 2, help = "frequency of using RoCLIP loss")
